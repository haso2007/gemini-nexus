...
export class ToolbarEvents {
    ...
    bind(elements, askWindow) {
        ...
        if (buttons.continue) this._add(buttons.continue, 'click', (e) => this.controller.actions.continueChat(e));
        if (buttons.copy) this._add(buttons.copy, 'click', (e) => this.controller.actions.copyResult(e));
        if (buttons.retry) this._add(buttons.retry, 'click', (e) => this.controller.actions.retryAsk(e));
        if (buttons.insert) this._add(buttons.insert, 'click', (e) => this.controller.actions.insertResult(e));
        if (buttons.replace) this._add(buttons.replace, 'click', (e) => this.controller.actions.replaceResult(e));
        ...
        this._add(askModelSelect, 'change', (e) => {
            ...
            viewUtils.resizeSelect(e.target);
        });
